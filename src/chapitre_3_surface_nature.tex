...
\begin{figure}[!b]
\centerline{
\includegraphics[angle=0, width=12cm, clip=true, trim=1cm 5cm 1cm 7cm]{\EPSDIR/ruisa.eps}
\includegraphics[angle=0, width=7cm,  clip=true, trim=1.5cm 1cm 0cm 4cm]{\EPSDIR/ruisb.eps}}
\caption{
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/quartz.eps,width=8cm}
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/wavedepthMPNP.eps,width=8cm}
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/wavedepthdaPL98.eps,width=8cm}
...
\begin{figure}[!b]
\centerline{ 
\includegraphics[angle=0, width=15cm]{\EPSDIR/isba-dif_water-thermal-grids.eps}}
\caption{
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/Eice.eps,width=8cm}
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/vapdif.eps,width=8cm}
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/vapdif2.eps,width=8cm}
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/kint_anglais.eps,width=10cm}
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/soilicet.eps,width=8cm}
...
\begin{figure}[h]
		 \begin{center}
		 \psfig{figure=\EPSDIR/fcurve2.eps,width=8cm}
...
\begin{figure}[!b]
\centerline{
\includegraphics[angle=0, width=12cm, clip=true, trim=4cm 0cm 3cm 0cm]{\EPSDIR/soil_org_carb.eps}}
...
\includegraphics[angle=0, width=10cm]{\EPSDIR/schematic_g_v_ng_na_colorfill.eps}}
\caption{
...
\includegraphics[angle=0, width=14cm, clip=true]{\EPSDIR/tree_resistance.eps}}
\caption{
...
\begin{figure}[!b]
\centerline{
\includegraphics[angle=0, width=12cm, clip=true, trim=0cm 0cm 0cm 0cm]{\EPSDIR/lwnet_meb.eps}}
